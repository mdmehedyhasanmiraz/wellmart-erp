...
export default function AddDesignationPage() {
  ...
  const generateCode = (name: string) => {
    return DesignationService.generateCode(name);
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (created) {
        ...
        alert('Failed to create designation. Please check the console for details.');
      }
    } catch (error) {
    ...
    <div className="max-w-4xl mx-auto space-y-6 w-full">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-2 text-gray-600">Create a new corporate designation</p>
        </div>
      </div>
