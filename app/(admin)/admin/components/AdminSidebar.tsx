...
export default function AdminSidebar() {
  ...
  const menuGroups = [
    ...
    {
      title: 'Operations',
      items: adminMenuItems.slice(1, 5), // Products, Inventory, Sales, Purchases
    },
    {
      title: 'Management',
      items: adminMenuItems.slice(5, 10), // Customers, Employees, Suppliers, Users, Branches
    },
    {
      title: 'Configuration',
      items: adminMenuItems.slice(10, 13), // Categories, Companies, Reports
    },
    {
      title: 'System',
      items: adminMenuItems.slice(13), // Settings
    },
  ];
