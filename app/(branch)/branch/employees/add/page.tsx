...
export default function BranchAddEmployeePage() {
  ...
  const branchSummary = useMemo(() => {
    return userProfile?.branch_name ?? 'your branch';
  ...
  if (!branchId) {
    return (
      <div className="min-h-[50vh] flex flex-col items-center justify-center text-center space-y-3">
        ...
        <p className="text-gray-600 max-w-md">Assign a branch to your profile to add employees.</p>
      </div>
    );
  }
    ...
    <div className="max-w-3xl mx-auto space-y-6 w-full">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-2 text-gray-600">Create a new employee record for {branchSummary}</p>
        </div>
      </div>
