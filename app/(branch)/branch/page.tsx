    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium">Active MPOs</p>
              <p className="text-3xl font-bold mt-2">{stats.totalMPOs}</p>
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium">Branch Sales</p>
      ...
      <div className="bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20">
        <div className="p-6 border-b border-white/20">
          <h2 className="text-xl font-bold">Branch Inventory</h2>
          <p className="text-sm mt-1">Current stock levels in your branch</p>
        </div>
        <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-colors cursor-pointer">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-sm">Update stock levels and track products</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-colors cursor-pointer">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h3 className="font-medium">Manage MPOs</h3>
              <p className="text-sm">Oversee MPO activities and performance</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-colors cursor-pointer">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h3 className="font-medium">Branch Reports</h3>
              <p className="text-sm">View branch performance analytics</p>
            </div>
          </div>
        </div>
      </div>
