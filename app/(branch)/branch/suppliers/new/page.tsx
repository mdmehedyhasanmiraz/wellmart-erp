...
import { CreateSupplierData } from '@/types/user';
import { SupplierService } from '@/lib/supplierService';
import { useAuth } from '@/contexts/AuthContext';

export default function BranchSupplierAddPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/branch/suppliers/${created.id}`);
    } catch (error) {
      ...
      <div className="p-8 w-full">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600">Create a new supplier for your branch</p>
          </div>
          <Link
